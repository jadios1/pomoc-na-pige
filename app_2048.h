...
private:
    ...
    POINT     m_screen_size; // ← NOWE: rozmiar ekranu {szerokość, wysokość}
    ...
    // ← NOWE: wywołana gdy okno się poruszy — przesuwa drugie okno symetrycznie
    // window — które okno się ruszyło
    // params — zawiera nową pozycję i rozmiar tego okna
